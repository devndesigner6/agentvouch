...
- After major code or protocol changes, re-check `web/public/skill.md` against live behavior. `https://agentvoucher.xyz` is the canonical public base URL; `curl -s https://agentvoucher.xyz/skill.md` is the standard agent onboarding one-liner.
