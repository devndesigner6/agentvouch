...
import {
  ...
  ROBINHOOD_TESTNET_CHAIN_LABEL,
  DEFAULT_ROBINHOOD_TESTNET_RPC_URL,
  DEFAULT_ROBINHOOD_TESTNET_EXPLORER_URL,
  DEFAULT_ROBINHOOD_AGENTVOUCH_ADDRESS,
  DEFAULT_ROBINHOOD_USDC_ADDRESS,
} from "./baseConstants";
...
export function getBaseWalletConfig() {
  if (isRobinhoodTestnetDefaultEnabled()) {
    return {
      chainContext: ROBINHOOD_TESTNET_CHAIN_CONTEXT,
      chainId: ROBINHOOD_TESTNET_CHAIN_ID,
      chainLabel: ROBINHOOD_TESTNET_CHAIN_LABEL,
      rpcUrl:
        process.env.NEXT_PUBLIC_ROBINHOOD_RPC_URL?.trim() ||
        DEFAULT_ROBINHOOD_TESTNET_RPC_URL,
      agentVouchAddress:
        process.env.NEXT_PUBLIC_ROBINHOOD_AGENTVOUCH_ADDRESS ||
        DEFAULT_ROBINHOOD_AGENTVOUCH_ADDRESS,
      usdcAddress:
        process.env.NEXT_PUBLIC_ROBINHOOD_USDC_ADDRESS ||
        DEFAULT_ROBINHOOD_USDC_ADDRESS,
      paymasterRpcUrl: "",
      explorerUrl: DEFAULT_ROBINHOOD_TESTNET_EXPLORER_URL,
      paidPurchaseReportsEnabled: false,
      configured: true,
    } as const;
  }
  return {
